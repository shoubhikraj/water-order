...
%CXX% /EHsc /Fe:Water_order /O2 /MD /fp:fast /openmp /I.\tclap-1.2.4\include /I.\chemfiles-install\include /I.\voro-71c84c8\src Water_order.cpp voro-71c84c8\src\voro++.cc /link .\chemfiles-install\lib\chemfiles.lib ws2_32.lib advapi32.lib
) else (
